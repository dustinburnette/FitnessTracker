...
namespace FitnessTracker.Controllers
{
    public class ExerciseTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ExerciseTypeID,Description")] ExerciseType exerciseType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ExerciseTypeID,Description")] ExerciseType exerciseType)
        {
            if (ModelState.IsValid)
            {
